...
アジェンダがあればそれを使い、なければ対話で作成してから、各スライドのレイアウト、完成文言、図表内容、出典、素材仕様を1枚ずつ詰め、HTMLのストーリーボードとして書き出すAgent Skillです。`npx skills` に対応しているエージェントへインストールできます。
...
- スライドに載せる見出し・本文・箇条書き・図中ラベルを、ワイヤーフレームのゾーンに対応させて記載する
- 表・グラフの項目、値、単位、注釈、出典を記載し、未提供の情報は「要確認」と明示する
- 発表者向け補足、出典・根拠、素材の準備事項を分けて記載する
